...
class ContactController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.contact.index',compact('contacts','name','email','phone','status','date','start','end'));
    }
    ...
    public function details(Request $request,$id)
    {
        ...
        return view('admin.contact.details',compact('contact','previous','next','total','leadnotes','callnotes','documents','activitieDates'));
    }
    ...
    public function delete(Request $request,$id)
    {
        ...
        return redirect()->route('admin.contact.list')->with('success', 'Deleted Successfully!');
    }
    ...
    public function add_note(Request $request,$id)
    {
        ...
        $contactnote->user_id = auth('admin')->user()->id;
