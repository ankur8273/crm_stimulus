...
class EmployeeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.employee.index',compact('employees','employee_id','employee_name'));
    }
    ...
    public function department_delete(Request $request)
    {
        ...
        $employee = Employee::where('department_id',$request->department_id)->first();
        if($employee){
            return redirect()->back()->with('error', 'First change Employee department on this department!');
        }
        $department->delete();
    ...
    public function designation(Request $request)
    {
        ...
        return view('admin.employee.designations',compact('designations'));
    }
    ...
    {
        $designation = Designation::where('id',$request->id)->first();
        $employee = Employee::where('designation_id',$request->id)->first();
        if($employee){
            return redirect()->back()->with('error', 'First change Employee designation on this designation!');
        }
        $designation->delete();
