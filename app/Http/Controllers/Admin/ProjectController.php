...
class ProjectController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.projects.index',compact('projects','name','status','date','start','end'));
    }
    ...
    public function details(Request $request,$id)
    {
        ...
        return view('admin.projects.details',compact('project','previous','next','total'));
    }
    ...
    public function change_status(Request $request,$id)
    {
        ...
        $this->send_notification([
            'project'=> $project,
            'message'=> 'Project Status By '
        ]);
        return redirect()->route('admin.project.list')->with('success', 'Status Updated Successfully!');
    }
    ...
    public function add_user(Request $request,$id)
    {
        ...
        $this->send_notification([
            ...
            'message'=> 'Project Owner added By '
        ]);
        return redirect()->back()->with('success', 'Updated Successfully!');
    }
    ...
    public function send_notification($data)
    {
        ...
        foreach($users as $user){
            ...
            if(permission($user,'Project') || ($data['project'] && $data['project']->user_id == $user->id)){
