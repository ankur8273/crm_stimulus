...
class PropertiesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.properties.index',compact('properties','name','status','date','start','end'));
    }
    ...
    public function details(Request $request,$id)
    {
        ...
        return view('admin.properties.details',compact('property','previous','next','total'));
    }
    ...
    public function change_status(Request $request,$id)
    {
        ...
        return redirect()->route('admin.properties.list')->with('success', 'Status Updated Successfully!');
    }
    ...
    public function send_notification($data)
    {
        ...
        foreach($admins as $admin){
            $admin->notify(new UserNotification([
                'property_id'=> $data['property']?$data['property']->id:'',
                'message'=> $data['message'].auth('admin')->user()->name,
                'url'=>$data['property']?route('admin.properties.details',$data['property']->id,):route('admin.properties.list')
            ])); 
        }
