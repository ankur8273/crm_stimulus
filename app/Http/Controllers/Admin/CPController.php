...
class CPController extends Controller
{
	...
	public function index(Request $request)
    {
        ...
        return view('admin.channel_partner.index',compact('CPartners','name','status','date','start','end'));
    }
	public function store(Request $request)
    {
		...
		$channel_partner->cp_status = $request->cp_status;
	...
	public function change_status(Request $request,$id)
    {
        ...
        return redirect()->route('admin.channel-partner.list')->with('success', 'Status Updated Successfully!');
    }
	...
	public function add_files(Request $request,$id)
    {
        ...
        if($request->hasFile('files')){
            ...
            $cpartner->files = json_encode($farr);
        }
	...
	public function send_notification($data)
    {
        ...
        foreach($admins as $admin){
            $admin->notify(new UserNotification([
                'cpartner_id'=> $data['cpartner']?$data['cpartner']->id:'',
                'message'=> $data['message'].auth('admin')->user()->name,
                'url'=>$data['cpartner']?route('admin.channel-partner.details',$data['cpartner']->id,):route('admin.channel-partner.list')
            ])); 
        }
	...
	public function details(Request $request,$id)
    {
        ...
        // dd($dates);
        return view('admin.channel_partner.details-cp',compact('cpartner','previous','next','total','leadnotes','callnotes','documents','activitieDates','projects'));
    }
     ...
     */
	 ...
	 public function add_note(Request $request)
	 {
		 ...
		 $cpartnernote->user_id = auth('admin')->user()->id;
