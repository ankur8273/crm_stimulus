...
class KnowledgebaseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.knowledgebase.index',compact('categories'));
    }
    public function details(Request $request,$id)
    {
        ...
        return view('admin.knowledgebase.details',compact('categories','knowledgebase','latest'));
    }

     public function category(Request $request)
    {
        $categories = KnowledgebaseCategory::orderBy('id','desc')->get();
        return view('admin.knowledgebase.category',compact('categories'));
    }
    ...
    {
        $categories = KnowledgebaseCategory::get();
        return view('admin.knowledgebase.create',compact('categories'));
    }

    public function store(Request $request)
    {
        $knowledgebase = new Knowledgebase();
        $knowledgebase->created_by = 'admin';
        $knowledgebase->added_by_id = auth('admin')->user()->id;
    ...
    public function edit(Request $request,$id)
    {
        $knowledgebase = Knowledgebase::findOrFail($id);
        $categories = KnowledgebaseCategory::get();
        return view('admin.knowledgebase.edit',compact('categories','knowledgebase'));
    }
