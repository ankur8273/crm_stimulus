...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none">
   <head>
      ...
      <meta name="description" content="JC Realtors">
      ...
      <script type="text/javascript">
        ...
        <script>
          function readURL(input,id) {
                ...
                if (input.files && input.files[0]&& (ext == "gif" || ext == "png" || ext == "jpeg" || ext == "jpg"|| ext == "webp"|| ext == "gif"|| ext == "svg")) {
        ...
        <script>
            function clear_notification(){
                $.ajax({
                url:"{{route('employee.clear_notification')}}",
                    method:'post',
                    data:{
                        '_token': '{{csrf_token()}}',
                        'status': status
