               ...
               <div class="row">
                     ...
                     <div class="contact-head">
                        <div class="row align-items-center">
                           ...
                           <div class="col-sm-6 text-sm-end">
                              @if(has_permission('CP') && has_permission('Read-CP'))
                              <div class="contact-pagination">
                                 <p>{{$cpartner->row+1 .' of '. $total}}</p>
                                 <ul>
                                    <li>
                                       @if($previous)
                                       <a href="{{route('employee.channel-partner.details',$previous)}}"><i class="fas fa-angle-left"></i></a>
                                       @endif
                                   </li>
                                   <li>
                                       @if($next)
                                       <a href="{{route('employee.channel-partner.details',$next)}}"><i class="fas fa-angle-right"></i></a>
                                       @endif
                                   </li>
                                 </ul>
                              </div>
                  ...
                  <div class="col-xl-3">
                     <div class="card contact-sidebar">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                           <h5>Contacts</h5>
                           @if(has_permission('Create-Contact'))
                           ...
                           <div class="tab-pane @if($tab=='note') active show @else fade @endif" id="notes">
                              ...
                              <div class="notes-activity">
                                 ...
                                 <div class="calls-box">
                                    <div class="caller-info">
                                       ...
                                       <div class="calls-action">
                                          <div class="dropdown action-drop">
                                             ...
                                             <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="javascript:void(0);" data-href="{{route('employee.channel-partner.delete_note',$leadnote->id)}}" onclick="delete_note($(this))"><i class="las la-trash me-1"></i>Delete</a>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    {!! $leadnote->comments !!}
                                    <form action="{{route('employee.channel-partner.add_comment')}}" method="post">
                                       @csrf
            ...
            <div id="next-followup" class="modal custom-modal fade" role="dialog">
               <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                     ...
                     <form action="{{route('employee.channel-partner.add_next_fellowup',$cpartner->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
            ...
            <div id="add_owner" class="modal custom-modal fade" role="dialog">
               <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                     ...
                     <form action="{{route('employee.channel-partner.add_owner',$cpartner->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                           <div class="input-group m-b-30">
            ...
            <div class="modal-dialog modal-dialog-centered">
               <div class="modal-content">
                  ...
                  <div class="modal-body p-0">
                     <form action="{{route('employee.channel-partner.add_note')}}" method="post" enctype="multipart/form-data" >
                        @csrf
                        <div class="input-block mb-3">
         ...
         <div class="modal custom-modal fade modal-padding" id="add_files" role="dialog">
            <div class="modal-dialog modal-dialog-centered">
               <div class="modal-content">
                  ...
                  <div class="modal-body p-0">
                     <form action="{{route('employee.channel-partner.add_file',$cpartner->id)}}" method="post" enctype="multipart/form-data" >
                        @csrf
                        <div class="input-block mb-3">
                           <label class="col-form-label">Title <span class="text-danger"> *</span></label>
                           <input class="form-control" type="text" name="title" required>
      ...
      <div class="modal custom-modal fade modal-padding" id="create_call" role="dialog">
            <div class="modal-dialog modal-dialog-centered">
               <div class="modal-content">
                  ...
                  <div class="modal-body p-0">
                     <form action="{{route('employee.channel-partner.add_call',$cpartner->id)}}" method="post">
                        @csrf
                        <div class="row">
                           <div class="col-md-6">
                              <div class="input-block mb-3">
     ...
     <script src="{{asset('assets/js/jquery-3.7.1.min.js')}}" type="712a4b0e0e5ee5c24248da6b-text/javascript"></script>
      ...
      <script type="text/javascript">
         function change_ladstatus(status){
            $.ajax({
               url:"{{route('employee.channel-partner.change_cp_status',$cpartner->id)}}",
                method:'post',
                data:{
                    '_token': '{{csrf_token()}}',
                    'status': status
         ...
         function change_fellouptus(status){
            $.ajax({
               url:"{{route('employee.channel-partner.change_fellowupType',$cpartner->id)}}",
                method:'post',
                data:{
                    '_token': '{{csrf_token()}}',
                    'status': status
