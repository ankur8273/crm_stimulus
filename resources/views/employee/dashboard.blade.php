...
<div class="page-wrapper">
    <div class="content container-fluid pb-0">
       <div class="page-header">
          <div class="row">
             <div class="col-sm-12">
                <h3 class="page-title">Welcome {{auth('employee')->user()->first_name.' '.auth('employee')->user()->last_name}}!</h3>
                <ul class="breadcrumb">
                            ...
                            <tr>
                               <td>
                                    <h2 class="table-avatar">
                                       <a href="#" class="avatar"><img src="{{asset('assets/img/employee/'.$employee->image)}}" alt="User Image"></a>
                            ...
                            <tr>
                               ...
                               <td class="text-end">
                                  <div class="dropdown dropdown-action">
                                     ...
                                     <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="javascript:void(0)" onclick="edit_contact($(this))" data-data="{{json_encode($contact->toArray())}}" data-user_name="{{$contact->user?($contact->user->first_name.' '.$contact->user->last_name):''}}"><i class="fa-solid fa-pencil m-r-5"></i> Edit</a>
