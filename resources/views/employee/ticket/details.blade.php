                     ...
                     <div class="ticket-chat">
                        <div class="ticket-chat-head">
                           ...
                           <div class="chat-post-box">
                              <form action="{{route('employee.ticket.send',$ticket->id)}}" method="post">
                                 @csrf
               ...
               <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                     ...
                     <div class="modal-body">
                        <form action="{{route('employee.ticket.add_files',$ticket->id)}}" method="post" enctype="multipart/form-data">
                           @csrf
            ...
            <div id="add_images" class="modal custom-modal fade" role="dialog">
               <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                     ...
                     <div class="modal-body">
                        <form action="{{route('employee.ticket.add_images',$ticket->id)}}" method="post" enctype="multipart/form-data">
                           @csrf
                           <div class="input-group m-b-30">
                              <input class="form-control search-input" type="file" name="files[]" multiple>
                              <button type="submit" class="btn btn-primary">Upload</button>
