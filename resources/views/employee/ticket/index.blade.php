...
@section('content')
   ...
   <div class="page-wrapper">
      <div class="content container-fluid">
                  ...
                  <div class="card">
                     <div class="card-body">
                        <div class="d-flex justify-content-between mb-3">
                           ...
                           <div>
                              <span class="text-success">{{$total??number_format($new/($total/1002),2)}}%</span>
                           </div>
                        </div>
                  ...
                  <div class="card">
                     <div class="card-body">
                        <div class="d-flex justify-content-between mb-3">
                           ...
                           <div>
                              <span class="text-success">{{$total??number_format($closed/($total/100),2)}}%</span>
                           </div>
                        </div>
                  ...
                  <div class="card">
                     <div class="card-body">
                        <div class="d-flex justify-content-between mb-3">
                           ...
                           <div>
                              <span class="text-danger">{{$total??number_format($opened/($total/100),2)}}%</span>
                           </div>
                        </div>
                  ...
                  <div class="card">
                     <div class="card-body">
                        <div class="d-flex justify-content-between mb-3">
                           ...
                           <div>
                              <span class="text-danger">{{$total??number_format($pending/($total/100),2)}}%</span>
                           </div>
                        </div>
         ...
         <form action="{{route('employee.ticket.list')}}" method="get">
                  ...
                  <table class="table table-striped custom-table mb-0 datatable">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td><a href="{{route('employee.ticket.details',$ticket->id)}}">#{{$ticket->ticket_id}}</a></td>
                           ...
                           <td>
                              <div class="dropdown action-label">
                                 ...
                                 <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="javascript:void(0);" onclick="change_status('{{route('employee.ticket.update_status',$ticket->id)}}','Open')"><i class="fa-regular fa-circle-dot text-info"></i> Open</a>
                                    <a class="dropdown-item" href="javascript:void(0);" onclick="change_status('{{route('employee.ticket.update_status',$ticket->id)}}','Reopened')"><i class="fa-regular fa-circle-dot text-info"></i> Reopened</a>
                                    <a class="dropdown-item" href="javascript:void(0);" onclick="change_status('{{route('employee.ticket.update_status',$ticket->id)}}','On Hold')"><i class="fa-regular fa-circle-dot text-danger"></i> On Hold</a>
                                    <a class="dropdown-item" href="javascript:void(0);" onclick="change_status('{{route('employee.ticket.update_status',$ticket->id)}}','Closed')"><i class="fa-regular fa-circle-dot text-success"></i> Closed</a>
                                    <a class="dropdown-item" href="javascript:void(0);" onclick="change_status('{{route('employee.ticket.update_status',$ticket->id)}}','In Progress')"><i class="fa-regular fa-circle-dot text-success"></i> In Progress</a>
                                    <a class="dropdown-item" href="javascript:void(0);" onclick="change_status('{{route('employee.ticket.update_status',$ticket->id)}}','Cancelled')"><i class="fa-regular fa-circle-dot text-danger"></i> Cancelled</a>
                                 </div>
                              </div>
                           </td>
                           <td class="text-end">
                              <div class="dropdown dropdown-action">
                                 ...
                                 <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item" href="javascript:void(0);" data-href="{{route('employee.ticket.delete',$ticket->id)}}" onclick="delete_m($(this))"><i class="fa-regular fa-trash-can m-r-5"></i> Delete</a>
                                    <a class="dropdown-item" href="{{route('employee.ticket.details',$ticket->id)}}"><i class="fa-regular fa-eye"></i> Preview</a>
                                 </div>
                              </div>
                           </td>
                        </tr>
