                  ...
                  <div class="col-md-12">
                     <div class="contact-head">
                        <div class="row align-items-center">
                           ...
                           <div class="col-sm-6 text-sm-end">
                              @if(has_permission('Lead') && has_permission('Read-Lead'))
                              <div class="contact-pagination">
                                 <p>{{$lead->row+1 .' of '. $total}}</p>
                                 <ul>
                                    <li>
                                       @if($previous)
                                       <a href="{{route('employee.leads.details',$previous)}}"><i class="fas fa-angle-left"></i></a>
                                       @endif
                                   </li>
                                   <li>
                                       @if($next)
                                       <a href="{{route('employee.leads.details',$next)}}"><i class="fas fa-angle-right"></i></a>
                                       @endif
                                   </li>
                                 </ul>
                              </div>
                     ...
                     <div class="contact-wrap">
                        <div class="contact-profile">
                           ...
                           <div class="name-user">
                              <h4>{{$lead->name}} @if($lead->add_to_favourite==1)<span class="star-icon"><i class="fa-solid fa-star"></i></span>@endif</h4>
                  ...
                  <div class="col-xl-3">
                     <div class="card contact-sidebar">
                        ...
                        <ul class="other-info">
                           ...
                           <li title="{{$lead->next_fellowup_remark}}">
                              <span class="other-title">Next Follow Up</span>
                              <span>{{$lead->next_followup}}</span>
                           ...
                           <div class="tab-pane @if($tab=='note') active show @else fade @endif" id="notes">
                              ...
                              <div class="notes-activity">
                                 ...
                                 <div class="calls-box">
                                    ...
                                    {!! $leadnote->comments !!}
                                    <form action="{{route('employee.leads.add_comment')}}" method="post">
                                       @csrf
            ...
            <div id="next-followup" class="modal custom-modal fade" role="dialog">
               <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                     ...
                     <form action="{{route('employee.leads.add_next_fellowup',$lead->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
            ...
            <div id="add_owner" class="modal custom-modal fade" role="dialog">
               <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                     ...
                     <form action="{{route('employee.leads.add_owner',$lead->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                           <div class="input-group m-b-30">
            ...
            <div id="add_project" class="modal custom-modal fade" role="dialog">
               <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                     ...
                     <form action="{{route('employee.leads.add_projects',$lead->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                           <div class="input-group m-b-30">
            ...
            <div class="modal-dialog modal-dialog-centered">
               <div class="modal-content">
                  ...
                  <div class="modal-body p-0">
                     <form action="{{route('employee.leads.add_note')}}" method="post" enctype="multipart/form-data" >
                        @csrf
                        <div class="input-block mb-3">
         ...
         <div class="modal custom-modal fade modal-padding" id="add_files" role="dialog">
            <div class="modal-dialog modal-dialog-centered">
               <div class="modal-content">
                  ...
                  <div class="modal-body p-0">
                     <form action="{{route('employee.leads.add_file',$lead->id)}}" method="post" enctype="multipart/form-data" >
                        @csrf
                        <div class="input-block mb-3">
                           <label class="col-form-label">Title <span class="text-danger"> *</span></label>
                           <input class="form-control" type="text" name="title" required>
      ...
      <div class="modal custom-modal fade modal-padding" id="create_call" role="dialog">
            <div class="modal-dialog modal-dialog-centered">
               <div class="modal-content">
                  ...
                  <div class="modal-body p-0">
                     <form action="{{route('employee.leads.add_call',$lead->id)}}" method="post">
                        @csrf
                        <div class="row">
                           <div class="col-md-6">
                              <div class="input-block mb-3">
     ...
     <script src="{{asset('assets/js/jquery-3.7.1.min.js')}}" type="712a4b0e0e5ee5c24248da6b-text/javascript"></script>
      ...
      <script type="text/javascript">
         function change_ladstatus(status){
            $.ajax({
               url:"{{route('employee.leads.change_lead_status',$lead->id)}}",
                method:'post',
                data:{
                    '_token': '{{csrf_token()}}',
                    'status': status
         ...
         function change_fellouptus(status){
            $.ajax({
               url:"{{route('employee.leads.change_fellowupType',$lead->id)}}",
                method:'post',
                data:{
                    '_token': '{{csrf_token()}}',
                    'status': status
         ...
         function change_status(status){
            $.ajax({
               url:"{{route('employee.leads.change_status',$lead->id)}}",
                method:'post',
                data:{
                    '_token': '{{csrf_token()}}',
                    'status': status
