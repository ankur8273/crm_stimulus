                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="profile-view">
                                 ...
                                 <div class="row">
                                    <div class="col-md-5">
                                       <div class="profile-info-left">
                                          ...
                                          <form action="{{route('employee.profile-image')}}" method="post" enctype="multipart/form-data">
                                          	@csrf
                              ...
                              <div class="pro-edit"><a data-bs-target="#change-password" data-bs-toggle="modal" class="edit-icon" href="#"><i class="fa-solid fa-key"></i></a> 
