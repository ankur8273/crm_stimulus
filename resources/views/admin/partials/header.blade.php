<div class="header">
   ...
   <ul class="nav user-menu">
      ...
      <li class="nav-item dropdown">
         ...
         <i class="fa-regular fa-bell"></i> <span class="badge rounded-pill" id="notify-count">{{count(auth('admin')->user()->unreadNotifications)>20?'20+':count(auth('admin')->user()->unreadNotifications)}}</span>
         </a>
      ...
      <li class="nav-item dropdown has-arrow main-drop">
         ...
         <span class="user-img">
            ...
            <img src="{{asset('assets/img/employee/'.auth('admin')->user()->image)}}" alt="User Image" id="profile-image">
            @else
            <img src="{{asset('assets/img/icons/profile-upload-img.svg')}}" alt="User Image" id="profile-image">
            @endif
         <span class="status online"></span></span>
         <span>{{auth('admin')->user()->first_name}}</span>
         </a>
