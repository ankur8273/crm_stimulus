                 ...
                 <div class="row">
                    ...
                    <div class="col-md-6">
                       <div class="profile-info-left">
                          ...
                          <form action="{{route('admin.smtp-update-settings')}}" method="post" enctype="multipart/form-data">
                             @csrf
                    ...
                    <div class="col-md-6">
                       <div class="profile-info-left">
                          ...
                          <form action="{{route('admin.smtp-test')}}" method="post" enctype="multipart/form-data">
                             @csrf
                             <div class="row">
                                <div class="col-md-12">
                                    <div class="input-block mb-3">
