               ...
               <div class="page-header">
                  <div class="row align-items-center">
                     ...
                     <div class="col-auto float-end ms-auto">
                        <a href="#" class="btn add-btn" href="javascript:void(0);" data-data="{{json_encode($project->toArray())}}" data-href="{{route('admin.project.update',$project->id)}}" onclick="edit_project($(this))"><i class="fa-solid fa-plus"></i> Edit Project</a>
               ...
               <div class="row">
                     ...
                     <div class="card">
                        <div class="card-body">
                           <h5 class="card-title m-b-20">Uploaded image files <button type="button" class="float-end btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#add_images"><i class="fa-solid fa-plus"></i> Add</button>
                              ...
                              <button type="button" class="float-end btn btn-primary btn-sm Cancel d-none" onclick="$('.img-edit').toggleClass('d-none');$('.edit').toggleClass('d-none');$(this).toggleClass('d-none');"><i class="fa-solid fa-cancel"></i> Cancel</button>
                           </h5>
                           <div class="row">
                              @if($project->images)
                              ...
                              <div class="col-md-3 col-sm-4 col-lg-4 col-xl-3">
                                 <div class="uploaded-box">
                                    <div class="uploaded-img">
                                       ...
                                       <span class="close-icon img-edit d-none" title="Remove" data-href="{{route('admin.project.image_delete',$project->id)}}?id={{$id}}" onclick="delete_file($(this))">X</span>
                                    </div>
                                    ...
                                    <ul class="files-action">
                                       <li class="dropdown dropdown-action">
                                          ...
                                          <div class="dropdown-menu dropdown-menu-right">
                                             ...
                                             <a class="dropdown-item" href="javascript:void(0)" data-href="{{route('admin.project.file_delete',$project->id)}}?id={{$keyd}}" onclick="delete_file($(this))">Delete</a>
                                          </div>
                                       </li>
                                    </ul>
                                 </div>
                  ...
                  <div class="col-lg-5 col-xl-4">
                     ...
                     <div class="card project-user">
                        <div class="card-body">
                           <h6 class="card-title m-b-20">Assigned USer <button type="button" class="float-end btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#assign_leader"><i class="fa-solid fa-plus"></i> Add/Change</button></h6>
                           <ul class="list-box">
                              <li>
                                 <a href="profile.html">
                                    <div class="list-item">
               ...
               <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                     ...
                     <div class="modal-body">
                        <form action="{{route('admin.project.add_files',$project->id)}}" method="post" enctype="multipart/form-data">
                           @csrf
            ...
            <div id="add_images" class="modal custom-modal fade" role="dialog">
               <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                     ...
                     <div class="modal-body">
                        <form action="{{route('admin.project.add_images',$project->id)}}" method="post" enctype="multipart/form-data">
                           @csrf
                           <div class="input-group m-b-30">
                              <input class="form-control search-input" type="file" name="files[]" multiple>
                              <button type="submit" class="btn btn-primary">Upload</button>
            ...
            <div id="assign_leader" class="modal custom-modal fade" role="dialog">
               <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                     ...
                     <form action="{{route('admin.project.add_user',$project->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                           <div class="input-group m-b-30">
