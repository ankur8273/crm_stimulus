                  ...
                  <div class="row align-items-center">
                     ...
                     <div class="col-auto float-end ms-auto">
                        ...
                        <div class="view-icons">
                           <a href="{{route('admin.project.list')}}" class="grid-view btn btn-link"><i class="las la-redo-alt"></i></a>
                     ...
                     <div class="table-responsive">
                        <table class="table table-striped custom-table datatable">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 <td>
                                    <a href="{{route('admin.project.details',$project->id)}}">{{$project->name}}</a>
                                 </td>
                                 <td>{{$project->city}}</td>
                                 <td>
                                 ...
                                 <td>
                                    <div class="dropdown action-label">
                                       ...
                                       <div class="dropdown-menu">
                                          <a class="dropdown-item" href="{{route('admin.project.change_status',$project->id)}}?status=1"><i class="fa-regular fa-circle-dot text-success"></i> Active</a>
                                          <a class="dropdown-item" href="{{route('admin.project.change_status',$project->id)}}?status=0"><i class="fa-regular fa-circle-dot text-danger"></i> Inactive</a>
                                       </div>
                                    </div>
                                 </td>
                                 <td class="text-end">
                                    <div class="dropdown dropdown-action">
                                       ...
                                       <div class="dropdown-menu dropdown-menu-right">
                                          ...
                                          <a class="dropdown-item" href="{{route('admin.project.details',$project->id)}}"><i class="fa-regular fa-eye"></i> Preview</a>
                                          <a class="dropdown-item" href="javascript:void(0);" data-href="{{route('admin.project.delete',$project->id)}}" onclick="delete_m($(this))"><i class="fa-regular fa-trash-can m-r-5"></i> Delete</a>
                                       </div>
                                    </div>
                                 </td>
                              </tr>
