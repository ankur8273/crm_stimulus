...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none">
   <head>
      ...
      <meta name="description" content=" Admin CRM">
      <meta name="keywords" content="admin,  management, CRM, Projects">
      <meta name="author" content="Admin CRM">
   ...
   <body class="account-page">
      <div class="main-wrapper">
         <div class="account-content">
            <!-- <a href="#" class="btn btn-primary apply-btn">Apply</a> -->
            <div class="container">
               <div class="account-logo">
                  <a href="#"><img src="{{asset('assets/logo/jclogo.webp')}}" alt="CRM"></a>
               </div>
