               ...
               <div class="page-header">
                  <div class="row align-items-center">
                     ...
                     <div class="col-auto float-end ms-auto">
                        <a href="{{route('admin.knowledgebase.create')}}" class="btn add-btn" ><i class="fa-solid fa-plus"></i> Add new</a>
                        <a href="{{route('admin.knowledgebase.category')}}" class="btn add-btn" ><i class="fa-solid fa-plus"></i> Add Category</a>
                  ...
                  <div class="col-xl-4 col-md-6 col-sm-6">
                     <div class="topics">
                        ...
                        <ul class="topics-list">
                           ...
                           <li>
                              <div class="pro-edit">
                                 <a  class="edit-icon icon-shed" href="{{route('admin.knowledgebase.edit',$topic->id)}}"><i class="fa-solid fa-pencil"></i></a>
                                 <a  class="edit-icon icon-shed" data-href="{{route('admin.knowledgebase.delete',$topic->id)}}" onclick="delete_m($(this))"><i class="fa-solid fa-trash"></i></a>
                              </div>
                              <a href="{{route('admin.knowledgebase.details',$topic->id)}}"> {{$topic->title}} </a>
                           </li>
                           @endforeach
                        </ul>
                     </div>
