                     ...
                     <div class="col-md-8 float-end ms-auto">
                        <div class="d-flex title-head">
                           <div class="view-icons">
                              <a href="{{route('admin.contact.list')}}" class="grid-view btn btn-link"><i class="las la-redo-alt"></i></a>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <h2 class="table-avatar d-flex">
                                       ...
                                       <a href="{{route('admin.contact.details',$contact->id)}}" class="profile-split d-flex flex-column">{{$contact->first_name.' '.$contact->last_name}} <span>{{$contact->job_title}}</span></a>
                                    </h2>
                                 </td>
                                 <td>{{$contact->phone}}</td>
                                 <td>{{$contact->email}}</td>
                                 ...
                                 <td class="text-end">
                                    <div class="dropdown dropdown-action">
									   ...
									   @if(admin_has_permission('Write-Contact'))
                                          ...
                                          <a class="dropdown-item" href="javascript:void(0);" data-href="{{route('admin.contact.delete',$contact->id)}}" onclick="delete_contact($(this))"><i class="fa-regular fa-trash-can m-r-5"></i> Delete</a>
										  @endif
										  @if(admin_has_permission('Read-Contact'))
                                          <a class="dropdown-item" href="{{route('admin.contact.details',$contact->id)}}"><i class="fa-regular fa-eye"></i> Preview</a>
										  @endif
										  @if(admin_has_permission('Write-Contact'))
                                          <a class="dropdown-item" href="javascript:void(0);" data-href="{{route('admin.contact.add_note',$contact->id)}}" onclick="add_notes($(this))"><i class="la la-file-prescription"></i> Notes</a>
										  @endif
                                       </div>
                                    </div>
                                 </td>
               ...
               <div class="modal-body p-0">
                  ...
                  <div class="add-info-fieldset">
                     <fieldset id="first-field">
                        <form action="https://smarthr.dreamstechnologies.com/html/template/contact-list.html">
