$(document).ready(function () {
    ...
    if ($(".bookingrange").length > 0) {
        ...
        var end = moment();
        if($(".bookingrange").val()!=''){
        	var dates = $(".bookingrange").val();
        		dates = dates.split('-');
        		start = moment(new Date(dates[0]));
        		end = moment(new Date(dates[1]));
        }
    ...
    if ($(".datetimepicker").length > 0) {
        $(".datetimepicker").datetimepicker({ format: "DD-MM-YYYY", icons: { up: "fa fa-angle-up", down: "fa-solid fa-angle-down", next: "fa-solid fa-angle-right", previous: "fa-solid fa-angle-left" } });
    }
    
    if ($(".joindatetimepicker").length > 0) {
        $(".joindatetimepicker").datetimepicker({
    ...
    if ($(".timepicker").length > 0) {
        $(".timepicker").datetimepicker({ format: "hh:mm:ss", icons: { up: "fa fa-angle-up", down: "fa-solid fa-angle-down", next: "fa-solid fa-angle-right", previous: "fa-solid fa-angle-left" } });
    }
    if ($(".datatable").length > 0) {
        $(".datatable").DataTable({ bFilter: false, language: { paginate: { next: ' <i class=" fa fa-angle-double-right"></i>', previous: '<i class="fa fa-angle-double-left"></i> ' } } });
    }
    ...
    if ($(".kanban-wrap").length > 0) {
        $(".kanban-wrap").sortable({ connectWith: ".kanban-wrap", handle: ".kanban-box", placeholder: "drag-placeholder" });
    }
    if ($(window).width() < 991) {
        $("html").each(function () {
    ...
    $(document).on("click", ".add-new-company", function () {
        var companycontent =
            ...
            '<div class="input-block mb-3">' +
            '<div class="d-flex justify-content-between align-items-center">' +
            '<label class="col-form-label">New Company <span class="text-danger">*</span></label>' +
            "</div>" +
    ...
    if ($(".kanban-drag-wrap").length > 0) {
        $(".kanban-drag-wrap").sortable({ connectWith: ".kanban-drag-wrap", handle: ".kanban-card", placeholder: "drag-placeholder" });
    }
    if ($(".project-slider").length > 0) {
        $(".project-slider").owlCarousel({
            ...
            responsive: { 0: { items: 1 }, 600: { items: 2 }, 992: { items: 2 }, 1200: { items: 3 }, 1400: { items: 4 } },
        });
    }
    if ($(".company-slider").length > 0) {
        $(".company-slider").owlCarousel({
            ...
            responsive: { 0: { items: 1 }, 600: { items: 2 }, 992: { items: 2 }, 1200: { items: 2 }, 1400: { items: 2 } },
        });
    }
    if ($(window).width() > 767) {
